...
const jwtSecret = process.env.JWT_SECRET || 'ndwsd93er932rh02'; // Use env var or fallback
const { z } = require('zod');
const { sendWelcomeEmail, sendProfileUpdateEmail, sendAccountDeletionEmail, sendPasswordResetEmail } = require('./emailController');
